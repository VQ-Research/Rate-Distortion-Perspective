...
CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node=2 --master_port=15593 train_refinement.py --VQ=online_vq --dataset_name=CelebAHQ --global_batch_size=64 --codebook_size=65536  --codebook_dim=16 --pq=1 --stage=refinement --alpha=1.0 --beta=1.0 --gamma=0.0 --checkpoint_name=checkpoint-online_vq_transplant_CelebAHQ_model_65536_16_1_loss_1.0_1.0_0.0_0.4.pth.tar
