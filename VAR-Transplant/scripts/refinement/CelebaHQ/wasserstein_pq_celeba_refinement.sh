#!/bin/bash
#SBATCH --job-name=wasserstein_pq_celeba_refinement
...
#SBATCH --output /project/6105494/sunset/VQ-Projects/Rate-Distortion-Perspective/VAR-Transplant/slurm/Refinement/CelebAHQ/wasserstein_pq_celeba_refinement.out
#SBATCH --error /project/6105494/sunset/VQ-Projects/Rate-Distortion-Perspective/VAR-Transplant/slurm/Refinement/CelebAHQ/wasserstein_pq_celeba_refinement.err
