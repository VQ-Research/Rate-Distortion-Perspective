#!/bin/bash
#SBATCH --job-name=wasserstein_pq_ffhq_transplant
...
#SBATCH --output /project/6105494/sunset/VQ-Projects/Rate-Distortion-Perspective/VAR-Transplant/slurm/Transplant/FFHQ/wasserstein_pq_ffhq_transplant.out
#SBATCH --error /project/6105494/sunset/VQ-Projects/Rate-Distortion-Perspective/VAR-Transplant/slurm/Transplant/FFHQ/wasserstein_pq_ffhq_transplant.err
