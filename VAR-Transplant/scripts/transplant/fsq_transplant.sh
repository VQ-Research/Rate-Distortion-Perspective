...
CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node=2 --master_port=13581 train_SQ_transplant.py --VQ=fsq --dataset_name=ImageNet --global_batch_size=64  --L=4 --project_dim=8 --stage=transplant --beta=1.0
