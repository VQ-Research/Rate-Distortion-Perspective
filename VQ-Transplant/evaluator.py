...
def main():
    ...
    parser.add_argument("--sample_path", default="/project/6105494/sunset/VQ-Projects/VQ-Transplant/reconstruction/Transplant/ImageNet", help="path to sample batch npz file")
