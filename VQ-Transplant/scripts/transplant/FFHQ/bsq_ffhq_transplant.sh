...
CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node=2 --master_port=13581 train_SQ_transplant.py --VQ=bsq --dataset_name=FFHQ --global_batch_size=64  --L=2 --project_dim=16 --stage=transplant --beta=1.0
