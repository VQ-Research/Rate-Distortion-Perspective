...
CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node=2 --master_port=13595 train_VQ.py --VQ=wasserstein_vq --dataset_name=CelebAHQ --global_batch_size=4 --codebook_size=65536  --codebook_dim=16 --pq=1 --alpha=1.0 --beta=0.2 --gamma=0.5
