...
class PQModel(nn.Module):
    def __init__(self, args):
        ...
        if args.VQ == "vanilla_vq":
            self.quantizer = VanillaProductQuantizer(args)
        elif args.VQ == "ema_vq":
            self.quantizer = EMAProductQuantizer(args)
        elif args.VQ == "online_vq":
            self.quantizer = OnlineProductQuantizer(args)
        elif args.VQ == "wasserstein_vq":
            self.quantizer = WassersteinProductQuantizer(args)
        elif args.VQ == "mmd_vq":
            self.quantizer = MMDProductQuantizer(args)
